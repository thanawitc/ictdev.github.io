...
<body>
<?php echo '<i style="color:red;font-size:30px;">      Who is Borrowing Tool</i>'?>
<br>
<br>
<form name="showall" method="" action="" target="footer">
...
$row=0;
$Sitem=1;
$sql4 = "SELECT * FROM borrow where condition_after is NULL;";
